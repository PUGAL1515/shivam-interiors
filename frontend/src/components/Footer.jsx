    ...
    <footer className="bg-gray-900 text-gray-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-4">
              ...
              <a 
                ...
                className="w-10 h-10 bg-gray-800 hover:bg-[#1877F2] rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110"
              >
                <FaFacebookF />
              </a>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 hover:bg-[#E1306C] rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110"
              >
                <FaInstagram />
              </a>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-6 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+917760408660" className="hover:text-white">
                  +91 77604 08660
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@sivaminteriors.com" className="hover:text-white">
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 text-center text-sm text-gray-500">
          ...
          <p className="mt-1 text-xs">Premium UPVC Solutions | Crafted with Excellence</p>
        </div>
      </div>
    </footer>
  );
