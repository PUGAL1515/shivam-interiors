      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center text-white pt-8 pb-20">
        ...
        <div className="flex justify-center mb-10">
          <div className="bg-white/95 backdrop-blur-md p-4 rounded-3xl shadow-2xl border border-[#FDFCEB]/30">
            <img 
              src={sivamLogo} 
              alt="Shivam Interiors - UPVC Windows and Interior Designers in Vellore" 
        ...
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-[-1px] mb-6">
          UPVC Windows & Interiors in Vellore<br />
          <span className="text-[#FDFCEB] tracking-[-0.5px]">
            Transforming Spaces into Timeless Homes
          </span>
        </h1>

        {/* ===== SEO Optimized Subtitle ===== */}
        <p className="max-w-3xl mx-auto text-xl md:text-2xl text-white/90 mb-12 font-light leading-relaxed">
          Premium UPVC Windows • UPVC Doors • Modular Kitchens • Wardrobes • False Ceilings<br />
          Complete Interior Solutions in Vellore, Chennai & Tamil Nadu Since 2016
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-8 -mt-10">
          {[
            ...
            <div 
              key={i} 
              className="bg-white/10 backdrop-blur-md px-8 py-3 rounded-2xl border border-white/30 hover:border-[#FDFCEB] hover:bg-white/20 transition-all text-sm md:text-base"
            >
              {service}
            </div>
          ))}
